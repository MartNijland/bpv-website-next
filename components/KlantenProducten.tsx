...
const KlantenProducten = (props: Props) => {
    return (
            ...
            <h3 className='absolute top-24 uppercase tracking-[10px]  md:tracking-[20px] text-gray-500 text-sm text-center  md:text-2xl'>Klanten en Procute<span className='tracking-[0px]'>n</span></h3>
