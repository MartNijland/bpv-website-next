    ...
    >
      <div className="flex [&:hover>div]:w-16 [&>div:hover]:w-[50rem]">
        <div className="group rounded-md relative h-[35rem] w-[50rem] overflow-hidden cursor-pointer shadow-lg shadow-black/30 transition-all duration-1000">
          <img
            src="https://wirelab2018.s3.amazonaws.com/Cases/Grolsch-BeugelPrinter/Wirelab_client_Grolsch_06.png"
            alt=""
            className="h-full object-cover group-hover:rotate-12 group-hover:scale-125 transition-all duration-300"
          />
            ...
            <div className="absolute inset-x-5 bottom-6">
              <div className="flex flex-col  text-white">
                <p className="font-semibold text-xl text-gray-100">
                  Grolsch Beugelsysteem
                </p>
                <p className="text-gray-300">
                  Curabitur blandit tempus porttitor. Vestibulum id ligula porta
                  felis euismod semper. Duis mollis, est non commodo luctus,
              ...
              <div className="flex justify-end gap-3 text-gray-200"></div>
            </div>
          </div>
        </div>
        <div className="group rounded-md relative h-[35rem] w-16 overflow-hidden cursor-pointer shadow-lg shadow-black/30 transition-all duration-500">
          <img
            src="https://wirelab2018.s3.amazonaws.com/Case-Image-3.png"
            alt=""
            className="h-full object-cover group-hover:rotate-12 group-hover:scale-125 transition-all duration-300"
          />
            ...
            <div className="absolute inset-x-5 bottom-6">
              <div className="flex flex-col text-white">
                ...
                <p className="text-gray-300">
                  ...
                  elit non mi porta gravida at eget metus. Cras mattis
                  consectetur purus sit amet fermentum. Cum sociis natoque
                  penatibus et magnis dis parturient montes, nascetur ridiculus
                  mus. Morbi leo risus, porta ac consectetur ac, vestibulum at
        ...
        <div className="group rounded-md relative h-[35rem] w-16 overflow-hidden cursor-pointer shadow-lg shadow-black/30 transition-all duration-500">
          <img
            src="https://wirelab2018.s3.amazonaws.com/Cases/Renault/Wirelab_client_Renault-Clio.jpg"
            alt=""
            className="h-full object-cover group-hover:rotate-12 group-hover:scale-125 transition-all duration-300"
          />
        ...
        <div className="group rounded-md relative h-[35rem] w-16 overflow-hidden cursor-pointer shadow-lg shadow-black/30 transition-all duration-500">
          <img
            src="https://wirelab2018.s3.amazonaws.com/Wirelab_client_segway-header.jpg"
            alt=""
            className="h-full object-cover group-hover:rotate-12 group-hover:scale-125 transition-all duration-300"
          />
            ...
            <div className="absolute inset-x-5 bottom-6">
              <div className="flex flex-col text-white">
                ...
                <p className="text-gray-300">
                  ...
                  porttitor. Maecenas sed diam eget risus varius blandit sit
                  amet non magna. Praesent commodo cursus magna, vel scelerisque
                  nisl consectetur et. Curabitur blandit tempus porttitor.
