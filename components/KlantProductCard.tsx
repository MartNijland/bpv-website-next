  ...
  return (
    ...
    >
      <motion.img
        ...
        src="https://wirelab2018.s3.amazonaws.com/Brands/Wirelab_Client_grolsch.svg"
        alt="Grolsch"
      />
      ...
      <div className="px-0 md:px-10">
        ...
        <div className="">
          <p className="uppercase py-5 text-gray-300 text-sm md:text-xl">
            Optimalisatie en crieeren van een nieuw design
          </p>
          <p className="text-xs md:text-base">
            Donec ullamcorper nulla non metus auctor fringilla. Nullam id dolor
