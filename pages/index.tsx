...
import Informatie, {queryFragment as informatieQueryFragment} from '../components/Informatie'
import BpvTaakEen, {queryFragment as bpvtaakeenQueryFragment} from '../components/BpvTaakEen'
...
const Home: NextPage = ({data}:any) => {
  ...
  return (
      ...
      <div className="bg-[#18232E] text-white h-screen snap-y snap-mandatory overflow-auto scrollbar scrollbar-thumb-[#7962FA] scrollbar-track-[#1f2c3a]">
        {loading ? ( <PropagateLoader size={20} color={"#7962FA"} loading={loading} cssOverride={override}/>
        ) : ( 
          <div>
          <CursorAnimation />
